...
<body id="top">
	<div class="site-wrap">
		<%@ include file="../templates/user/layout/sidebar.jsp"%>

		<%@ include file="../templates/user/layout/header.jsp"%>
								...
								<c:forEach var="userDonation" items="${userDonations }">
									<li class="comment">
										...
										<div class="comment-body">
											...
											<p>${userDonation.money > 0 ? userDonation.money : 0}vnđ</p>
										</div>
									</li>
								</c:forEach>
							</ul>
					...
					<div class="col-lg-6">
						<div class="bg-light p-3 border rounded mb-4">
							...
							<ul class="list-unstyled pl-3 mb-0">
								...
								<li class="mb-2"><strong class="text-black">Ngày
										bắt đầu: </strong>${donation.start_date }</li>
								<li class="mb-2"><strong class="text-black">Ngày
										kết thúc: </strong>${donation.end_date }</li>
								<li class="mb-2"><strong class="text-black">Cá
										nhân/Tổ chức: </strong>${donation.organization_name }</li>
								<li class="mb-2"><strong class="text-black">Số
										điện thoại: </strong>${donation.phone_number }</li>
								<li class="mb-2"><strong class="text-black">Tổng
										tiền quyên góp nhận được: </strong>${donation.money > 0 ? donation.money : 0 }
									vnđ</li>
								<li class="mb-2"><strong class="text-black">Trạng
										thái:</strong> <span> <c:choose>
						...
						<div class="bg-light p-3 border rounded">
							<button type="button" style="color: white" data-toggle="modal"
								...
								<c:choose>
											<c:when test="${donation.status == 1}"> </c:when>
			...
			<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form method="post" action="add-user-donation">
		...
		<%@ include file="../templates/user/layout/footer.jsp"%>
	</div>
</body>
</html>
